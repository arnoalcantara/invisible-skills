...
8. **Regressão de marca.** Sem gradiente (exceto overlay de imagem), sem sombra, sem emoji, sem radius acima do `--radius` do brand; tipografia nos pisos de legibilidade (lei 11).
