#!/usr/bin/env python3
"""Bootstrap da invisible-acelerador.

A skill é ffmpeg puro — acelera com os filtros `setpts` (vídeo) e `atempo`
(áudio), ambos embutidos no ffmpeg. Sem Node, sem WhisperX, sem modelo externo.
