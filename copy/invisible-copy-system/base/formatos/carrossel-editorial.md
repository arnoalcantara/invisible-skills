# Carrossel Editorial — Módulo de Método para IA

> **O que é.** Um dos três modos de carrossel da `invisible-carrossel`. Transforma material escrito bruto num carrossel que **posiciona uma opinião** — tese, conflito, argumento e fecho que reverbera. Ritmo de artigo, não de lista. Escreve para quem pensa.
>
> **Quando usar este modo.** A intenção é *ocupar espaço no debate com uma posição* — defender uma tese, enfrentar um discurso vazio, formar opinião. Sem necessidade de dado externo (≠ percepção) e sem lista de ações (≠ autoridade). Se precisar de prova/dado, use `carrossel-percepcao.md`; se precisar de aplicabilidade prática, use `carrossel-autoridade.md`.
>
> **Lugar na cadeia.** Estende `formatos/carrossel.md`. Puxa da base: `niveis-de-consciencia.md`, `copy/angulos.md`, `big-idea.md`, `macroestrutura.md`, `copy/figuras-de-retorica.md`, `copy/portugues-natural.md`. Este arquivo traz **só o que é específico do modo editorial**.
...
## 1. A tese (a unidade deste modo)

Todo carrossel editorial defende **uma tese** ao longo dos slides. Uma boa tese:
- Cabe numa frase com impacto
- É defendida do começo ao fim
...
## 2. Estrutura dos slides — a linha de raciocínio (7–12, default 10)

Sequência: **gancho → tensão → argumento → virada → encerramento**. Papel de cada bloco:

- **Slide 1 — Título com tese e tensão.** Peso de chamada de capa. Pergunta ou afirmação, mas com conflito ou promessa intelectual. Nunca óbvio ("Como fazer X", "3 formas de Y" são proibidos aqui).
- **Slides 2 a 4 — Ampliação do conflito.** Contexto/diagnóstico, descrição do erro ou prática obsoleta, consequência. Situa o leitor.
- **Slide de virada (≈5) — A chave gira.** "A nova tendência não é gritar. É aprofundar."
- **Slides 6 a 8 — Desenvolvimento do argumento.** O novo caminho, aprofundado. Cada slide qualifica o anterior. Pode haver frase de abertura + expansão abaixo (como título + subtítulo), mas em prosa, não em bullet.
- **Slide 9 — Pergunta retórica ou convite à reflexão.** Reengaja, consolida a tese, prepara o fecho.
- **Slide 10 — Encerramento editorial.** Nunca CTA genérico. Ver Seção 4.

> Cada slide tem papel narrativo real (contextualizar, provocar, exemplificar, diferenciar, concluir). Nunca gira em falso, nunca repete.
...
- **Perguntas fracas:** "Você quer crescer no Instagram?" Se usar pergunta, que tenha tensão.

Regras de cadência: frases com sujeito, verbo e impacto; varie curtas/médias com pausas; pontuação é ênfase, não enfeite. Resto: `copy/portugues-natural.md`.

---

## 6. Cruzamento com a base
- **Big Idea (`big-idea.md`):** a tese editorial muitas vezes É a Big Idea, dita como posição.
...
## 7. Checklist do modo
1. Há uma tese clara com conflito (não uma observação morna)?
2. A linha de raciocínio avança slide a slide (gancho → tensão → argumento → virada → fecho)?
